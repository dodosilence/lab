                ...
                <div class="login-box">
                    <div class="panel">
                        <div class="panel-body">
                            ...
                            <form class="form-horizontal login" action="${pageContext.request.contextPath}/login.do"
                                  method="post">
                                <div class="bk-padding-left-20 bk-padding-right-20">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group input-group-icon">
                                            <input type="text" name="username" class="form-control bk-radius"
                                                   id="username" placeholder="Username or E-mail"/> <span
                                    ...
                                    <div class="form-group">
                                        <label>验证码</label>
                                        <div class="input-group input-group-icon">
                                            <input type="text" name="code" class="form-control bk-radius"
                                                   id="code" placeholder="输入右侧验证码"/>
												<span class="input-group-addon">
                                                    <span class="icon">
                                            <img src="${pageContext.request.contextPath}/login/code" style="width: 100px"/>
												    </span>
												</span>
                                        </div>
                                    </div>
                                    <div class="row bk-margin-top-20 bk-margin-bottom-10">
                                        ...
                                        <div class="col-sm-4 text-right">
                                            <button type="button" onclick="ogin()" class="btn btn-primary hidden-xs">
                                                登录
                                            </button>
                                            <button type="submit"
                                        ...
                                        <script>
                                            function ogin() {
                                                if ($("#username").attr("value").length <= 1) {
                                                    alert("请输入用户名")
                                                } else if ($("#password").attr("value").length <= 0) {
                                                    alert("请输入密码")
                                                } else {
                                                    $(".login").submit()
                                                }
