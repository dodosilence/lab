                                ...
                                <div class="bk-padding-left-20 bk-padding-right-20">
                                    <div class="form-group">
                                        <label>用户名</label><label
                                            style="color: red;">${requestScope.registerinfo}</label>
                                    ...
                                    <div class="row bk-margin-top-20 bk-margin-bottom-10">
                                        ...
                                        <div class="col-sm-4 text-right">
                                            <button type="submit" class="btn btn-primary hidden-xs" id="sub">点击注册</button>
                                            <script>
                                                $(function(){
                                                    alert("暂不支持注册")
                                                })
                                    ...
                                    <p class="text-center">
                                        已经拥有用户名? <a href="${pageContext.request.contextPath}/page-login.html">登录吧!</a>
                                </div>
                            </form>
                        </div>
                    </div>
