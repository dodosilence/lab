            ...
            <nav id="menu" class="nav-main" role="navigation">
                <ul class="nav nav-sidebar">
                    ...
                    <li class="nav-parent"><a> <i class="fa fa-table"
                        ...
                        <ul class="nav nav-children">
                            <li><a href="${pageContext.request.contextPath}/student/course/list/${sessionScope.user.uuid}"><span class="text">
										参与课程</span></a></li>
                            <li><a href="${pageContext.request.contextPath}/student/project/list/${sessionScope.user.uuid}"><span class="text">
										实验列表</span></a></li>
                        </ul>
                    </li>
                </ul>
