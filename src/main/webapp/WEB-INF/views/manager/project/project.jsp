            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                <div class="panel bk-widget bk-border-off">
                    <div class="panel-body bk-bg-very-light-gray">
                        <h4 class="bk-margin-off-bottom bk-docs-font-weight-300">${project.projectName}(${project.startDateTime})</h4>
                        ...
                        <a href="${pageContext.request.contextPath}/mgr/labs/list/${project.uuid}"><h6
