        ...
        <div class="navbar-right">
            ...
            <div class="userbox">
                <c:if test="${sessionScope.user==null}">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        <figure class="profile-picture hidden-xs">
                            <img src="${pageContext.request.contextPath}/assets/img/noLogin.jpg" class="img-circle" alt=""/>
                        </figure>
                ...
                <c:if test="${sessionScope.user!=null}">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        <figure class="profile-picture hidden-xs">
                            <img src="${pageContext.request.contextPath}/assets/img/avatar2.jpg" class="img-circle" alt=""/>
                        </figure>
                        <div class="profile-info">
            ...
            <nav id="menu" class="nav-main" role="navigation">
                <ul class="nav nav-sidebar">
                    ...
                    <li class="nav-parent"><a> <i class="fa fa-list-alt"
                                                  aria-hidden="true"></i><span>实验室管理</span>
                    </a>
                        <ul class="nav nav-children">
                            <c:forEach var="labStyle" items="labStyles">
                                <li><a href="${pageContext.request.contextPath}/"><span class="text">
										所有货物</span></a></li>
                            </c:forEach>
                        </ul>
                    </li>
