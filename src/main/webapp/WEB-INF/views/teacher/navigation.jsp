            ...
            <nav id="menu" class="nav-main" role="navigation">
                <ul class="nav nav-sidebar">
                    ...
                    <li class="nav-parent"><a> <i class="fa fa-table"
                                                  aria-hidden="true"></i><span>我的课程</span>
                    </a>
                        <ul class="nav nav-children">
                            <li><a href="${pageContext.request.contextPath}/teacher/course/list/${sessionScope.user.uuid}"><span class="text">
										课程管理</span></a></li>
                            <li><a href="${pageContext.request.contextPath}/teacher/project/list/${sessionScope.user.uuid}"><span class="text">
										实验列表</span></a></li>
                        </ul>
                    </li>
                </ul>
